...
export function activate(context: vscode.ExtensionContext){
	...
	let disposable = vscode.commands.registerCommand('extension.reDocViewer', () => {
		...
		if(editor) {
            ...
            // const previewInBrowser: boolean = !!vscode.workspace.getConfiguration('reDocViewer').previewInBrowser;
            // if(previewInBrowser){
